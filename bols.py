...
ADMIN_ID = 123456789  # <--- GANTI ANGKA INI DENGAN ID ANDA
...
async def show_main_menu(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    # (Kode fungsi ini sama seperti milik Anda, tidak diubah)
    ...
    main_buttons = [
        ...
        InlineKeyboardButton("Paket Aniv", callback_data='buy_aniv_direct'),
    ]
...
#
# --- SALIN SEMUA FUNGSI BOT ANDA YANG LAIN DI SINI ---
# (Mulai dari 'initiate_login' hingga '_process_direct_aniv_qris_payment')
# Saya tidak akan menampilkannya lagi untuk menghemat ruang,
# tapi pastikan Anda menyalinnya dari kode asli Anda.
#
...
async def _process_direct_aniv_qris_payment(
    ...
    try:
        ...
        transaction_id = settlement_qris(
            ...
            ts_to_sign=ts_to_sign,
            payment_target=package_code,
            price=0,  # <-- KIRIM HARGA ASLI PAKET (yaitu 0)
            item_name=package_name,
            force_amount=True # <-- TAMBAHKAN INI UNTUK MENGAKTIFKAN LOGIKA BARU
        )
...
def main() -> None:
    ...
    # Pastikan admin selalu memiliki akses
    ...
    # Daftarkan handler untuk tombol dan pesan
