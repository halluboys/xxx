...
chck_pid
echo -e "
[${GREEN}01${NC}] ${color1} •${color3}$white Create L2TP Account
[${GREEN}02${NC}] ${color1} •${color3}$white Deleting L2TP Account
[${GREEN}03${NC}] ${color1} •${color3}$white Extending L2TP Account Active Life
