...
chck_pid
echo -e "
[${GREEN}01${NC}] ${color1} •${color3}$bd Create Account SSTP
[${GREEN}02${NC}] ${color1} •${color3}$bd Delete SSTP Account
[${GREEN}03${NC}] ${color1} •${color3}$bd Extending SSTP Account Active Life
[${GREEN}04${NC}] ${color1} •${color3}$bd Check User Login SSTP
