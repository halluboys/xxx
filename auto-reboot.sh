...
echo -e "[\e[36m•2\e[0m] Set Auto-Reboot Setiap 3 Jam"
echo -e "[\e[36m•3\e[0m] Set Auto-Reboot Setiap 6 Jam"
echo -e "[\e[36m•4\e[0m] Set Auto-Reboot Setiap 12 Jam"
echo -e "[\e[36m•5\e[0m] Set Auto-Reboot Setiap 1 Hari"
echo -e "[\e[36m•6\e[0m] Set Auto-Reboot Setiap 1 Minggu"
echo -e "[\e[36m•7\e[0m] Set Auto-Reboot Setiap 1 Bulan"
echo -e "[\e[36m•8\e[0m] Matikan Auto-Reboot"
...
echo "10 */3 * * * root /usr/local/bin/reboot_otomatis" > /etc/cron.d/reboot_otomatis
echo "Auto-Reboot has been successfully set every 3 hours."
