...
async def show_main_menu(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    main_buttons = [
        ...
        InlineKeyboardButton("2. Login Cepat", callback_data='quick_login_start'), # Tombol baru
...
async def process_quick_login(update: Update, context: ContextTypes.DEFAULT_TYPE, phone_number: str) -> None:
    ...
    try:
        ...
        # 2. Periksa apakah nomor sudah pernah login
        ...
        # 3. Nomor sudah pernah login, coba aktifkan
